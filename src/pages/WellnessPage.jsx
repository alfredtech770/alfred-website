...
@media(max-width:390px){.w-hero{height:280px!important}.w-title{font-size:28px!important}.search-bar{grid-template-columns:1fr!important}}
      ...
      <section className="w-hero" style={{height:420,position:"relative",overflow:"hidden"}}>
        <div style={{position:"absolute",inset:0,transform:"translateY("+heroY+"px)"}}><img src="https://fbdgbnnkgyljehtccgaq.supabase.co/storage/v1/object/public/Website/_%20(76).jpeg" alt="Wellness" style={{width:"100%",height:"120%",objectFit:"cover"}}/></div>
