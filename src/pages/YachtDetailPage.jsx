...
export default function YachtDetailPage(){
  ...
  var YACHT = {
    ...
    notes: yacht.notes || "",
    price4hr: yacht.price_4hr,
    price6hr: yacht.price_6hr,
    price8hr: yacht.price_8hr,
        ...
        <div className="two-col">
          ...
          <div className="left-col">
            ...
            <div ref={specsRef} style={{paddingTop:20,marginBottom:24}}>
              {secDiv}
              <p style={{...sf(10,500),color:C.s7,letterSpacing:5,textTransform:"uppercase",marginBottom:16,marginTop:20,opacity:1,transition:"all 0.8s ease"}}>Specifications</p>
            ...
            {/* Description */}
            {YACHT.description&&<div style={{paddingTop:20,marginBottom:24}}>
              {secDiv}
              <p style={{...sf(15,400),color:C.s4,lineHeight:1.8,marginTop:20}}>{YACHT.description}</p>
            </div>}
            ...
            <div ref={priceRef} style={{paddingTop:20,marginBottom:24}}>
              ...
              <div style={{borderRadius:20,background:C.el,border:"1px solid "+C.bd,padding:"0 20px",opacity:1,transition:"all 0.9s ease 0.15s"}}>
                {[
                  {label:"4 hr",price:YACHT.price4hr||YACHT.priceWeekday4hr},
                  {label:"6 hr",price:YACHT.price6hr||YACHT.priceWeekday6hr},
                  {label:"8 hr",price:YACHT.price8hr||YACHT.priceWeekday8hr},
                ].map(function(row,i){
              ...
              <a href={"https://wa.me/message/DAO44K3XCXK3F1?text="+encodeURIComponent("Hi, I have a question about the "+YACHT.name)} target="_blank" rel="noopener noreferrer" style={{display:"flex",alignItems:"center",gap:14,padding:"16px clamp(14px,3vw,22px)",borderRadius:20,background:"rgba(244,244,245,0.03)",border:"1px solid "+C.bd,cursor:"pointer",marginTop:12,textDecoration:"none",transition:"border-color 0.3s"}} onMouseEnter={function(e){e.currentTarget.style.borderColor=C.s7}} onMouseLeave={function(e){e.currentTarget.style.borderColor=C.bd}}>
            ...
            {/* What's Included */}
            {YACHT.features.length>0&&<div ref={inclRef} style={{paddingTop:20,marginBottom:24}}>
              {secDiv}
            ...
            {/* Not Included */}
            {YACHT.notIncluded.length>0&&<div style={{paddingTop:20,marginBottom:24}}>
              {secDiv}
              <p style={{...sf(10,500),color:C.s7,letterSpacing:5,textTransform:"uppercase",marginBottom:16,marginTop:20}}>Not Included</p>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
            ...
            {/* Tags / Features */}
            {YACHT.tags.length>0&&<div style={{paddingTop:20,marginBottom:24}}>
              {secDiv}
              <p style={{...sf(10,500),color:C.s7,letterSpacing:5,textTransform:"uppercase",marginBottom:16,marginTop:20}}>Features & Amenities</p>
            ...
            {/* Payment Methods */}
            {YACHT.paymentMethods.length>0&&<div style={{paddingTop:20,marginBottom:24}}>
              {secDiv}
              <p style={{...sf(10,500),color:C.s7,letterSpacing:5,textTransform:"uppercase",marginBottom:16,marginTop:20}}>Payment Methods</p>
            ...
            {/* Notes */}
            {YACHT.notes&&<div style={{paddingTop:20,marginBottom:24}}>
              {secDiv}
              <p style={{...sf(10,500),color:C.s7,letterSpacing:5,textTransform:"uppercase",marginBottom:16,marginTop:20}}>Notes</p>
