...
@media(max-width:390px){.n-hero{height:280px!important}.n-title{font-size:28px!important}.search-bar{grid-template-columns:1fr!important}}
      ...
      {/* Hero */}
      <section className="n-hero" style={{height:420,position:"relative",overflow:"hidden"}}>
        <div style={{position:"absolute",inset:0,transform:"translateY("+heroY+"px)"}}><img src="https://fbdgbnnkgyljehtccgaq.supabase.co/storage/v1/object/public/Website/Keinmusik.jpeg" alt="Nightlife" style={{width:"100%",height:"120%",objectFit:"cover"}}/></div>
          ...
          <div className="search-bar">
            ...
            <div>
              ...
              <div style={{display:"flex",gap:0}}>
                {["2","4","6","10+"].map(function(g){var active=guests===g;return <div key={g} onClick={function(){setGuests(g)}} style={{padding:"11px 14px",background:active?"rgba(244,244,245,0.06)":"transparent",border:"1px solid "+C.bd,marginLeft:-1,cursor:"pointer",...sf(13,active?600:400),color:active?C.s1:C.s6,transition:"all 0.2s"}}>{g}</div>})}
              </div>
            </div>
