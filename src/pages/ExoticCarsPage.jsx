...
@media(max-width:390px){.ec-hero{height:280px!important}.ec-title{font-size:28px!important}.search-bar{grid-template-columns:1fr!important}}
      ...
      <section className="ec-hero" style={{height:420,position:"relative",overflow:"hidden"}}>
        <div style={{position:"absolute",inset:0,transform:"translateY("+heroY+"px)"}}><img src="https://fbdgbnnkgyljehtccgaq.supabase.co/storage/v1/object/public/Website/Aston%20Martin.jpeg" alt="Exotic Cars" style={{width:"100%",height:"120%",objectFit:"cover"}}/></div>
