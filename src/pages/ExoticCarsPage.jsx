...
function carDesc(car){
  ...
  if(t==="Hypercar") return h+"hp "+e+" hypercar available for a supplier-confirmed rental request.";
...
function CarCard(p){
  ...
  function goWA(e){e.preventDefault();e.stopPropagation();window.open("https://wa.me/33650938152?text="+encodeURIComponent("Hi Alfred, I'm interested in renting the "+car.name+". Could you let me know about availability and pricing?"),"_blank")}
  return(
...
export default function ExoticCarsPage(){
  ...
  return(
    <div style={{width:"100%",minHeight:"100vh",background:C.bg,...sf(15),color:C.s1,overflowX:"hidden"}}>
      <SEOHead {...SEO.exoticCars} image="/og-exotic-cars.jpg"/>
      <style>{`
...
@media(max-width:480px){
  ...
  .search-bar{grid-template-columns:1fr!important}
      ...
      <div style={{paddingTop:100,paddingBottom:40,textAlign:"center",opacity:loaded?1:0,transform:loaded?"translateY(0)":"translateY(16px)",transition:"all 1s cubic-bezier(0.16,1,0.3,1)"}}>
        ...
        <p style={{...sf(16,400),color:C.s5}}>Browse supercars, classics and chauffeured options.</p>
      </div>
