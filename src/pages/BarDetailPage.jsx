...
export default function BarDetailPage(){
  ...
  return(
    <div style={{width:"100%",minHeight:"100vh",background:C.bg,...sf(15),color:C.s1,overflowX:"hidden"}}>
      <SEOHead title={V.name+" Paris — Book a Table | Alfred Concierge"} description={"Dinner and cocktails at "+V.name+". "+V.type+" with "+V.music+" in the heart of Paris. Reservations through Alfred."} image={V.imgs&&V.imgs[0]?V.imgs[0]:"/og-nightlife.jpg"} path={"/catalog/nightlife/l-arc"} />
      <style>{`
...
@media(max-width:390px){.bl-hero{height:320px!important}.bl-name{font-size:26px!important}.facts-g{grid-template-columns:1fr 1fr!important}}
      ...
      <div className="vw" style={{marginTop:-40,position:"relative",zIndex:10,marginBottom:20,opacity:loaded?1:0,transform:loaded?"translateY(0)":"translateY(12px)",transition:"all 0.9s cubic-bezier(0.16,1,0.3,1)"}}>
        ...
        <div style={{display:"flex",gap:10,marginTop:24}}>
          <a onClick={function(){window.open("https://wa.me/33650938152?text="+encodeURIComponent("Hi Alfred, I'd like to get on the guestlist for "+V.name+". Could you arrange access?"),"_blank")}} style={{display:"flex",alignItems:"center",gap:8,padding:"12px 22px",borderRadius:14,background:C.s1,...sf(13,600),color:C.bg,transition:"transform 0.3s",cursor:"pointer"}} onMouseEnter={function(e){e.currentTarget.style.transform="translateY(-1px)"}} onMouseLeave={function(e){e.currentTarget.style.transform="translateY(0)"}}>
            Get on the Guestlist
          </a>
          <a onClick={function(){window.open("https://wa.me/33650938152?text="+encodeURIComponent("Hi Alfred, I'd like to get on the guestlist for "+V.name+". Could you arrange access?"),"_blank")}} style={{display:"flex",alignItems:"center",gap:8,padding:"12px 22px",borderRadius:14,border:"1px solid "+C.bd,...sf(13,500),color:C.s4,transition:"all 0.3s",cursor:"pointer"}} onMouseEnter={function(e){e.currentTarget.style.borderColor=C.s5;e.currentTarget.style.color=C.s1}} onMouseLeave={function(e){e.currentTarget.style.borderColor=C.bd;e.currentTarget.style.color=C.s4}}>
      ...
      <section ref={ctaRef} style={{padding:"140px 0 120px",position:"relative"}}><div style={divider}/>
        <div style={{textAlign:"center",maxWidth:500,margin:"0 auto",padding:"0 40px"}}>
          ...
          <div style={{display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap",opacity:ctaVis?1:0,transform:ctaVis?"translateY(0)":"translateY(16px)",transition:"all 0.9s ease 0.4s"}}>
            <a onClick={function(){window.open("https://wa.me/33650938152?text="+encodeURIComponent("Hi Alfred, I'd like to get on the guestlist for "+V.name+". Could you arrange access?"),"_blank")}} style={{display:"inline-flex",alignItems:"center",gap:8,padding:"16px 32px",borderRadius:14,background:C.s1,...sf(14,600),color:C.bg,transition:"transform 0.3s,box-shadow 0.3s",cursor:"pointer"}} onMouseEnter={function(e){e.currentTarget.style.transform="translateY(-3px)";e.currentTarget.style.boxShadow="0 12px 40px rgba(244,244,245,0.1)"}} onMouseLeave={function(e){e.currentTarget.style.transform="translateY(0)";e.currentTarget.style.boxShadow="none"}}>
              Get on the Guestlist
